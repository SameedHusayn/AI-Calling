...
class AudioRecorder:
    ...
    def __init__(
        self, silence_threshold=SILENCE_THRESHOLD, silence_duration=SILENCE_DURATION
    ):
            ...
            if rms > self.silence_threshold:
                ...
                if self.speech_detected:
                    ...
                    if silence_time >= self.silence_duration:
                        print(
                            f"Detected {silence_time:.2f}s of silence. Auto-stopping recording."
                        )
                        self.is_recording = False
    ...
    async def start_recording(self, auto_stop=True):
        ...
        print(
            f"Waiting for speech, then will auto-stop after {self.silence_duration} seconds of silence"
        )
